...
# 段階的移行: 既存の開発機能を継続使用
from app.api.v1.features.feature_dev.seed_data import clear_data, seed_data
...
async def clear_data_endpoint(session: SessionDep) -> dict:
    """
    【開発用】全テーブルのクリア処理
...
async def seed_data_endpoint(session: SessionDep) -> dict:
    """
    【開発用】全テーブルのシーダー処理
